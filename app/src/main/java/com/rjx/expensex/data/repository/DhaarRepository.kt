...
import com.rjx.expensex.data.local.AccountDao
import com.rjx.expensex.data.local.ContactDao
import com.rjx.expensex.data.local.DhaarEntryDao
import com.rjx.expensex.data.local.TransactionDao
    ...
    suspend fun insertDhaarEntry(
        ...
        if (linkToAccount && entry.linkedAccountId != null && entry.linkedAccountId > 0) {
            ...
            val txTypeEnum = when (entry.type.uppercase()) {
                "GIVEN" -> com.rjx.expensex.data.model.TransactionType.EXPENSE
                "RECEIVED" -> com.rjx.expensex.data.model.TransactionType.INCOME
                "SETTLEMENT" -> {
                    if (entry.isSettlementGive == true) com.rjx.expensex.data.model.TransactionType.EXPENSE else com.rjx.expensex.data.model.TransactionType.INCOME
                }
                else -> com.rjx.expensex.data.model.TransactionType.EXPENSE
            }
            ...
            val transaction = TransactionEntity(
                ...
                categoryColorHex = if (txTypeEnum == com.rjx.expensex.data.model.TransactionType.INCOME) "#10B981" else "#EF4444",
