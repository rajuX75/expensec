...
object ImageStorageHelper {
     ...
     * [com.rjx.expensex.data.cloud.CloudinaryImageUploadWorker] to retry when online.
     */
    suspend fun saveImageLocally(
        ...
        if (localUri.startsWith("file://")) {
            val cloudUrl = com.rjx.expensex.data.cloud.CloudinaryUploader.upload(context, localUri, folderName)
            if (cloudUrl != null) {
    ...
    fun enqueueUploadWorker(context: Context) {
        try {
            val uploadWorkRequest =
                androidx.work.OneTimeWorkRequestBuilder<com.rjx.expensex.data.cloud.CloudinaryImageUploadWorker>()
                    .setConstraints(
