...
import com.rjx.expensex.data.cloud.CloudBackupRepository
import com.rjx.expensex.data.cloud.CloudBackupResult
import com.rjx.expensex.data.cloud.DriveAuthorizeResult
import com.rjx.expensex.data.cloud.GoogleAuthManager
import com.rjx.expensex.data.local.AppDatabase
import com.rjx.expensex.data.model.*
import com.rjx.expensex.data.repository.CurrencyInfo
import com.rjx.expensex.data.repository.ExpenseRepository
import com.rjx.expensex.data.repository.ImportExportRepository
import com.rjx.expensex.data.repository.UserPreferencesRepository
import com.rjx.expensex.ui.common.charts.BarChartEntry
import com.rjx.expensex.ui.common.charts.CategoryTrendMeta
import com.rjx.expensex.ui.common.charts.ChartCategoryData
import com.rjx.expensex.ui.common.charts.MonthlyCategoryTrendEntry
...
class ExpenseViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val dhaarRepository = com.rjx.expensex.data.repository.DhaarRepository(
    ...
    val notificationRepository = com.rjx.expensex.data.repository.NotificationRepository(userPrefs, firebaseConfigManager, viewModelScope)
    ...
    init {
        ...
        if (userPrefs.cloudinaryCloudName.value.isNotBlank()) {
            try {
                val uploadWorkRequest = androidx.work.OneTimeWorkRequestBuilder<com.rjx.expensex.data.cloud.CloudinaryImageUploadWorker>()
                    .setConstraints(
    ...
    val shopBakiRepository = com.rjx.expensex.data.repository.ShopBakiRepository(
    ...
    val feedbackRepository = com.rjx.expensex.data.repository.FeedbackRepository()
    ...
    fun submitFeedback(entry: com.rjx.expensex.data.model.FeedbackEntry) = feedbackDelegate.submitFeedback(entry)
    ...
    init {
        ...
        viewModelScope.launch {
            remoteUpdateInfo.collect { info ->
                if (info != null && updateRepository.isUpdateAvailable(info)) {
    ...
    fun markBillAsPaid(bill: BillEntity) {
        viewModelScope.launch(Dispatchers.IO) {
            com.rjx.expensex.domain.usecase.MarkBillPaidUseCase(
    ...
    fun transferFunds(
        ...
        viewModelScope.launch(Dispatchers.IO) {
            com.rjx.expensex.domain.usecase.TransferFundsUseCase(
                repository = repository,
                firestoreSyncManager = firestoreSyncManager,
                getCurrentUserId = { googleAuthManager.currentUserId }
    ...
    suspend fun testCloudinaryConnection(): Result<String> {
        return com.rjx.expensex.data.cloud.CloudinaryUploader.testConnection(getApplication<Application>())
    }
