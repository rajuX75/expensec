...
import com.rjx.expensex.data.model.Shop
import com.rjx.expensex.data.model.ShopLedgerEntry
import com.rjx.expensex.data.model.ShopProduct
import com.rjx.expensex.data.model.ShopTimelineItem
...
import com.rjx.expensex.data.repository.ShopBakiRepository
    ...
    private suspend fun logPaymentToRecentTransactions(entry: ShopLedgerEntry) {
        runCatching {
            ...
            val tx = TransactionEntity(
                type = com.rjx.expensex.data.model.TransactionType.EXPENSE,
                amount = entry.amount,
                categoryId = cat?.id ?: 0,
