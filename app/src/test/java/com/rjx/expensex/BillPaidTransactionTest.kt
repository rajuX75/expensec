...
import com.rjx.expensex.data.model.BillEntity
...
import com.rjx.expensex.domain.usecase.MarkBillPaidUseCase
...
class BillPaidTransactionTest {
    ...
    fun setUp(): Unit = runBlocking {
        ...
        val userPrefs = com.rjx.expensex.data.repository.UserPreferencesRepository(ctx)
        val syncManager = com.rjx.expensex.data.cloud.FirestoreSyncManager(ctx, db, userPrefs)
